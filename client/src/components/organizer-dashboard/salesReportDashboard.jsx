...
import { OrganizerHomeDashboard } from "./OrganizerHomeDashboard";
import { SalesDashboardContent } from "./SalesReport";
...
const SidebarContent = ({ onClose, ...rest }) => {
   ...
   const addEvent = () => {
      navigate("/buildyourpage/addevent");
   };
