...
import { checkoutData } from "../../redux/checkoutSlice";
        ...
        >
          ...
          <Flex alignItems={"center"} gap={"20px"}>
            {token ? (
              ...
              <>
                <UserLogin />
                <Link href="/userRegister" color={"gray.500"} fontSize={"14px"}>
                  Register
                </Link>
              </>
            )}
                ...
                <Box>
                  ...
                  <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
                    <List spacing={2}>
                      ...
                      <ListItem>Location</ListItem> <ListItem>Date</ListItem>
                      <ListItem>Ticket amount</ListItem>
                    </List>
                    <List spacing={2}>
                      <ListItem>: {events.Category.category}</ListItem>
                      <ListItem>
                        : {events.City.city}, {events.Country.country}
                      </ListItem>
