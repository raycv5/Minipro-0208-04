      ...
      <Grid templateColumns="20vw 80vw">
        ...
        <GridItem h="100vh" bgColor={"gray.50"} p={"10px"}>
          ...
          <Flex
            ...
            sx={{
              background:
                "linear-gradient(to bottom right, rgba(128, 128, 128, 0.2), white, white, rgba(128, 128, 128, 0.1),white, white, rgba(128, 128, 128, 0.3))",
            }}
          >
            ...
            <Flex gap={"10px"} flexDir={"Column"} pl={"20px"} fontSize={"18px"}>
              <Text mt={"20px"}>
                Congrats this is your gift of referral code.
              </Text>
              <Text>What is referral code?</Text>
              <Text>
                Referral code is a code that you can use to get a discount for
                the events you want to attend, then
              ...
              <OrderedList mr={"50px"}>
                ...
                <ListItem mb={"15px"}>
                  <Text>
                    Every time you share this code, you will receive an
                    additional 20 points, and your friend will receive 10 points
                    if they use the referral code that have you been sent.
                  </Text>
                </ListItem>

                <ListItem>
                  <Text mb={"15px"}>
                    For every 100 points you accumulate, you will receive a 5%
                    discount on the event you wish to attend.
                  </Text>
                </ListItem>

                <ListItem>
                  <Text mb={"15px"}>
                    The maximum number of points for each event is 1000 points,
                    and the maximum discount you can receive is 50%.
                  </Text>
                </ListItem>

                <ListItem>
                  <Text>
                    This referral code has one-month time limit from the date of
                    your registration on this website.
                  </Text>
                </ListItem>
