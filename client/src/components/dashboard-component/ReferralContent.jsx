  ...
  `;
    ...
    <> 
      ...
      <GridItem h="100vh" bgColor={"gray.50"} p={"10px"}>
        <Heading textAlign="center" mb="20px"  >Referral Code Time Remaining</Heading>
          <Text textAlign={"center"} mb={"20px"}>Your referrence {user.referralCode} code will expire in: </Text>
          ...
          <Box 
            ...
            <Flex
              ...
              >
              <Text fontSize={"60px"}>{hours} 
              <Text display={"inline"} style={{ animation: "blink 1s infinite" }}>:</Text>
               {minutes}</Text> 
            </Flex>
          </Box>
          <Text textAlign={"center"} mt={"5px"}>{hours} Hours:{minutes} minutes:{seconds} seconds</Text> 
      </GridItem>        
  </Grid>  
</>
   );
